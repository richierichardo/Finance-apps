...
export default function Create({ wallets, categoriesIncome = [], categoriesExpenses = [] }) {
    ...
    const categories = data.type === 'income' ? categoriesIncome : categoriesExpenses;
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <DatePicker
                                selected={data.occurred_at ? new Date(data.occurred_at) : null}
                                onChange={(date) => {
                                    if (date) setData('occurred_at', date.toISOString());
                                }}
                                showTimeSelect
                                timeFormat="HH:mm"
                                timeIntervals={15}
